...
1. Фабрика `vkstream` — позволяет сформировать поток с желаемым набором [правил](https://vk.com/dev/streaming_api_docs?f=2.%20%D0%A4%D0%BE%D1%80%D0%BC%D0%B0%D1%82%20%D0%BF%D1%80%D0%B0%D0%B2%D0%B8%D0%BB) и считывать из него данные;
2. Более низкоуровневые объекты `VKStreamingAPI` и `VKWebSocket` — для случаев, когда `vkstream` недостаточно гибок для вашей задачи.
